# `nico-ops` perf benches

PRD-005 lands four criterion benches here in subsequent slices
(`idle_tick_bench`, `fan_out_bench`, `reducer_bench`, `render_bench`).
This file is a placeholder so the directory ships in Slice 0a.1
alongside the fixture and dev-dep scaffolding. Slice 0a.2 fills in
the bench harness and pastes baseline numbers below.
...
cargo bench -p nico-ops --features dhat-heap
```
